...
namespace Facturacion.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        {
            var facturacionContext = _context.Usuario.Include(u => u.IdProveedorNavigation);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var usuario = await _context.Usuario
                .Include(u => u.IdProveedorNavigation)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,Nombre,Apellido,Telefono,IdProveedor")] Usuario usuario)
        {
