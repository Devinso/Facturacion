...
namespace Facturacion.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,Nombre,Apellido,Producto,Telefono")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("IdProveedor,Nombre,Apellido,Producto,Telefono")] Proveedor proveedor)
        {
